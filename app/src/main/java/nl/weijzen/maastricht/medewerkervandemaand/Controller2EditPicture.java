        ...
        switch (selectedButtonId){
            case R.id.imageButtonSaveCompoundPicture:
                    ...
                    if (validFilename(filename)) {
                        ...
                        displayToastMessage(R.string.warning_invalid_filename);
                    }
...
//        Uri outputFileUri = useContentProviderToProvideUri(outputFile);
    ...
    private Uri useContentProviderToProvideUri(File outputFile) {
        /* To provide compatibility with Android Nougat (24) and above, use
           Content Provider to provide a content:// Uri instead of a file:// Uri.
           This prevents a FileUriExposedException
         */
        return FileProvider.getUriForFile(Controller2EditPicture.this,
